  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 p-4 md:p-6 shadow-sm h-full flex flex-col">
      <div className="mb-4 shrink-0">
        <h3 className="text-lg font-bold text-slate-800">Rincian Skill</h3>
        <p className="text-slate-500 text-xs mt-0.5">Perbandingan persentase skill yang dimiliki vs standar kebutuhan role target</p>
      </div>
            ...
            <div key={index} className="space-y-1.5 border-b border-slate-50 pb-3 last:border-b-0 last:pb-0">
              ...
              <div className="flex items-center justify-between text-sm font-semibold">
                ...
                <div className="flex items-center gap-1">
                  {isGap ? (
                    <span className="flex items-center gap-0.5 text-rose-600 text-xs bg-rose-50 px-2 py-0.5 rounded font-bold">
                      <TrendingDown className="w-3.5 h-3.5" />
                      {item.gap}%
                    </span>
                  ) : (
                    <span className="flex items-center gap-0.5 text-emerald-600 text-xs bg-emerald-50 px-2 py-0.5 rounded font-bold">
